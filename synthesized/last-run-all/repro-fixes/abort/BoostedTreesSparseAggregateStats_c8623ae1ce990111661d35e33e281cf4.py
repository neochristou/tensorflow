...
tf.raw_ops.BoostedTreesSparseAggregateStats(node_ids=arg_0, gradients=arg_1, hessians=arg_2,
                                            feature_indices=arg_3, feature_values=arg_4, feature_shape=arg_5, max_splits=3, num_buckets=4)
