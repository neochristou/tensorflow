#   File "/media/ivysyn/tensorflow/synthesized/all-crashes/all/QuantizedConcat_f99764ed2985896947c0d9437a8cd85d.py", line 6    values = tf.constant(?, shape=[2,2,3], dtype=tf.qint32)                         ^SyntaxError: invalid syntax
