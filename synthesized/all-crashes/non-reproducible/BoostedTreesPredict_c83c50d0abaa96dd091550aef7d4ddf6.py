#   File "/home/neo/mlfuzz/tensorflow/synthesized/all-crashes/all/BoostedTreesPredict_c83c50d0abaa96dd091550aef7d4ddf6.py", line 3    arg_0 = tf.constant(?, shape=[], dtype=tf.resource)                        ^SyntaxError: invalid syntax
