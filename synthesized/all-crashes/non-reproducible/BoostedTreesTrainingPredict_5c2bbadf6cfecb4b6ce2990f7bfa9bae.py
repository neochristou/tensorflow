#   File "/home/neo/mlfuzz/tensorflow/synthesized/all-crashes/all/BoostedTreesTrainingPredict_5c2bbadf6cfecb4b6ce2990f7bfa9bae.py", line 3    arg_0 = tf.constant(?, shape=[], dtype=tf.resource)                        ^SyntaxError: invalid syntax
