#   File "/home/neo/mlfuzz/tensorflow/synthesized/all-crashes/all/CreateSummaryFileWriter_b83f3bfe6f30983555103da17c3c52ed.py", line 3    arg_0 = tf.constant(?, shape=[], dtype=tf.resource)                        ^SyntaxError: invalid syntax
...
arg_4 = tf.constant("/tmp/summary_ops_testg2m3nixp/tmpfszc9_p4", shape=[], dtype=tf.string)
