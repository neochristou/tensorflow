...
ckpt_path = tf.constant("/tmp/warm_starting_util_test1t7fu1yy/tmp4zivjml4/model-0", shape=[], dtype=tf.string)
old_tensor_name = tf.constant("/tmp/warm_starting_util_test1t7fu1yy/tmp4zivjml4/model-0", shape=[], dtype=tf.string)
